...
object CodeBuildStateType {
  ...
  @inline val FAILED: CodeBuildStateType = "FAILED".asInstanceOf[CodeBuildStateType]
  @inline val STOPPED: CodeBuildStateType = "STOPPED".asInstanceOf[CodeBuildStateType]
}

@js.native
sealed trait CodeBuildPhaseType extends js.Any {}
object CodeBuildPhaseType {
  @inline val COMPLETED: CodeBuildPhaseType = "COMPLETED".asInstanceOf[CodeBuildPhaseType]
  @inline val FINALIZING: CodeBuildPhaseType = "FINALIZING".asInstanceOf[CodeBuildPhaseType]
  @inline val UPLOAD_ARTIFACTS: CodeBuildPhaseType = "UPLOAD_ARTIFACTS".asInstanceOf[CodeBuildPhaseType]
  @inline val POST_BUILD: CodeBuildPhaseType = "POST_BUILD".asInstanceOf[CodeBuildPhaseType]
  @inline val BUILD: CodeBuildPhaseType = "BUILD".asInstanceOf[CodeBuildPhaseType]
  @inline val PRE_BUILD: CodeBuildPhaseType = "PRE_BUILD".asInstanceOf[CodeBuildPhaseType]
  @inline val INSTALL: CodeBuildPhaseType = "INSTALL".asInstanceOf[CodeBuildPhaseType]
  @inline val QUEUED: CodeBuildPhaseType = "QUEUED".asInstanceOf[CodeBuildPhaseType]
  @inline val DOWNLOAD_SOURCE: CodeBuildPhaseType = "DOWNLOAD_SOURCE".asInstanceOf[CodeBuildPhaseType]
  @inline val PROVISIONING: CodeBuildPhaseType = "PROVISIONING".asInstanceOf[CodeBuildPhaseType]
  @inline val SUBMITTED: CodeBuildPhaseType = "SUBMITTED".asInstanceOf[CodeBuildPhaseType]
}

@js.native
sealed trait CodeBuildPhaseStatusType extends js.Any {}
object CodeBuildPhaseStatusType {
  @inline val TIMED_OUT: CodeBuildPhaseStatusType = "TIMED_OUT".asInstanceOf[CodeBuildPhaseStatusType]
  @inline val STOPPED: CodeBuildPhaseStatusType = "STOPPED".asInstanceOf[CodeBuildPhaseStatusType]
  @inline val FAILED: CodeBuildPhaseStatusType = "FAILED".asInstanceOf[CodeBuildPhaseStatusType]
  @inline val SUCCEEDED: CodeBuildPhaseStatusType = "SUCCEEDED".asInstanceOf[CodeBuildPhaseStatusType]
  @inline val FAULT: CodeBuildPhaseStatusType = "FAULT".asInstanceOf[CodeBuildPhaseStatusType]
  @inline val CLIENT_ERROR: CodeBuildPhaseStatusType = "CLIENT_ERROR".asInstanceOf[CodeBuildPhaseStatusType]
}

@js.native
sealed trait CodeBuildCacheType extends js.Any {}
object CodeBuildCacheType {
  @inline val NO_CACHE: CodeBuildCacheType = "NO_CACHE".asInstanceOf[CodeBuildCacheType]
  @inline val LOCAL: CodeBuildCacheType = "LOCAL".asInstanceOf[CodeBuildCacheType]
...
object CodeBuildSourceLocationType {
  @inline val CODECOMMIT: CodeBuildSourceLocationType = "CODECOMMIT".asInstanceOf[CodeBuildSourceLocationType]
  @inline val CODEPIPELINE: CodeBuildSourceLocationType = "CODEPIPELINE".asInstanceOf[CodeBuildSourceLocationType]
  @inline val GITHUB: CodeBuildSourceLocationType = "GITHUB".asInstanceOf[CodeBuildSourceLocationType]
  @inline val GITHUB_ENTERPRISE: CodeBuildSourceLocationType =
    "GITHUB_ENTERPRISE".asInstanceOf[CodeBuildSourceLocationType]
  @inline val BITBUCKET: CodeBuildSourceLocationType = "BITBUCKET".asInstanceOf[CodeBuildSourceLocationType]
  @inline val S3: CodeBuildSourceLocationType = "S3".asInstanceOf[CodeBuildSourceLocationType]
  @inline val NO_SOURCE: CodeBuildSourceLocationType = "NO_SOURCE".asInstanceOf[CodeBuildSourceLocationType]
}

@js.native
sealed trait CodeBuildEnvironmentType extends js.Any {}
object CodeBuildEnvironmentType {
  @inline val LINUX_CONTAINER: CodeBuildEnvironmentType = "LINUX_CONTAINER".asInstanceOf[CodeBuildEnvironmentType]
  @inline val LINUX_GPU_CONTAINER: CodeBuildEnvironmentType =
    "LINUX_GPU_CONTAINER".asInstanceOf[CodeBuildEnvironmentType]
  @inline val WINDOWS_CONTAINER: CodeBuildEnvironmentType = "WINDOWS_CONTAINER".asInstanceOf[CodeBuildEnvironmentType]
  @inline val ARM_CONTAINER: CodeBuildEnvironmentType = "ARM_CONTAINER".asInstanceOf[CodeBuildEnvironmentType]
}
...
object CodeBuildEnvironmentVariableType {
  ...
  @inline val PLAINTEXT: CodeBuildEnvironmentVariableType = "PLAINTEXT".asInstanceOf[CodeBuildEnvironmentVariableType]
