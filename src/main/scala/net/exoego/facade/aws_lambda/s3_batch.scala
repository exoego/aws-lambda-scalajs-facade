...
trait S3BatchResult extends js.Object {
  var invocationSchemaVersion: String = js.native
  var treatMissingKeysAs: literal.S3BatchResultResultCode = js.native
  var invocationId: String = js.native
...
object S3BatchResult {
  def apply(
      invocationSchemaVersion: String,
      treatMissingKeysAs: literal.S3BatchResultResultCode,
      invocationId: String,
...
trait S3BatchResultResult extends js.Object {
  var taskId: String = js.native
  var resultCode: literal.S3BatchResultResultCode = js.native
...
object S3BatchResultResult {
  def apply(
      taskId: String,
      resultCode: literal.S3BatchResultResultCode,
      resultString: String
  ): S3BatchResultResult = {
    val _obj$ = js.Dynamic.literal(
      "taskId" -> taskId.asInstanceOf[js.Any],
