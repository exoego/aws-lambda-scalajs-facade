...
trait CodePipelineCloudWatchPipelineEvent extends js.Object {
  ...
  var `detail-type`: literal.CodePipelineCloudWatchPipelineDetailType = js.native
  var source: literal.CodePipelineCloudWatchPipelineSource = js.native
...
object CodePipelineCloudWatchPipelineEvent {
  def apply(
      version: String,
      id: String,
      `detail-type`: literal.CodePipelineCloudWatchPipelineDetailType,
      account: String,
      time: String,
      region: String,
