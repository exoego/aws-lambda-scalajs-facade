...
trait CodePipelineCloudWatchStageEvent extends js.Object {
  ...
  var `detail-type`: literal.CodePipelineCloudWatchStageDetailType = js.native
  var source: literal.CodePipelineCloudWatchStageSource = js.native
...
object CodePipelineCloudWatchStageEvent {
  def apply(
      version: String,
      id: String,
      `detail-type`: literal.CodePipelineCloudWatchStageDetailType,
      account: String,
      time: String,
      region: String,
